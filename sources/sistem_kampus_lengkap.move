...
// Owned Object Nilai Mata Kuliah
...
fun init(ctx: &mut TxContext) {
    ...
    let registry = KampusRegistry {
        id: object::new(ctx),
        nama_kampus: string::utf8(b"Universita Blockchain Indonesia"),
        total_mahasiswa: 0,
...
//u update profile sendiri

public fun update_semester(profile: &mut MahasiswaProfile, semester_baru: u8, ctx: &TxContext) {
...
// updatre IPK berdasarkan nilai yang dimiliki
...
public fun get_mahasiswa_info(
    profile: &MahasiswaProfile,
): (String, u32, String, u8, u64, u64, bool) {
    (
        profile.nama,
        profile.nim,
        profile.jurusan,
...
public fun get_nilai_info(nilai: &NilaiMataKuliah): (u32, String, String, u8, u8) {
    (nilai.nim_mahasiswa, nilai.kode_mk, nilai.nama_mk, nilai.sks, nilai.nilai)
}
